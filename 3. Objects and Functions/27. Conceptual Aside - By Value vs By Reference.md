...
JavaScript maneja la asignación y el paso de datos a funciones de dos formas distintas, dependiendo del tipo de dato:
...
- Cambiar propiedades a través de `y` también modifica lo que ves desde `x`.
...
Lo que cambia es **qué tipo de valor** se copia:
...
- Cambiar un objeto a través de una variable afecta a todas las que compartan la misma referencia.
- JavaScript siempre pasa argumentos **por valor**, pero ese valor puede ser una referencia.
- Reasignar una variable dentro de una función **no** afecta a la variable original.
- Mutar un objeto dentro de una función **sí** afecta al original.

---

Anterior Tema: [Functions Statements and Function Expressions](3.%20Objects%20and%20Functions/26.%20Function%20Statements%20and%20Function%20Expressions.md) | Siguiente Tema: [Objects, Functions and 'this'](3.%20Objects%20and%20Functions/28.%20Objects%2C%20Functions%20and%20'this'.md) | Volver al índice: [Índice Temático](./README.md)
